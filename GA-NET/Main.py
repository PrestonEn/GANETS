...
def main():
    ...
    map(lambda ind: ind.setComscore(r), pop)
    ...
    for gen in xrange(generations):
        ...
        while len(new_pop) < population_size:
            ...
            p1 = roulette_select()
            p2 = roulette_select()
            child = Individual.UniformCrossOver(p1, p2, crossover_rate)
    ...
    filename = "../imgs/GA-NET"+str(time.time())+ graph_path[12:] + ".png"
    vals = (seed,
            "GA-Net",
...
if __name__ == "__main__":
    ...
    if FLAGS.graph_path == "":
        ...
        graph_path = ntpath.basename("../gml_files/karate.gml")
        g.write_gml("../gml_files/karate.gml")
    else:
        g = Graph.Read_GML(FLAGS.graph_path),
        graph_path = ntpath.basename(FLAGS.graph_path)
